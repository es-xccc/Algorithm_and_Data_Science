...
plt.savefig('p4_1_Threshold values k for Maximum Accuracies.png')
...
plt.savefig('p4_1_Maximum Accuracies.png')
...
plt.legend()
plt.savefig('p4_1_Mean Accuracies for Different Threshold Values.png')