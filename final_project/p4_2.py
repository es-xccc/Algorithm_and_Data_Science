...
plt.savefig('p4_2_Threshold values k for Maximum Accuracies.png')
...
plt.savefig('p4_2_Maximum Accuracies.png')
...
plt.legend()
plt.savefig('p4_2_Mean Accuracies for Different Threshold Values.png')