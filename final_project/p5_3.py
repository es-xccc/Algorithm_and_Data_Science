...
plt.savefig('p5_3_Threshold values k for Maximum Accuracies.png')
...
plt.savefig('p5_3_Maximum Accuracies.png')
...
plt.legend()
plt.savefig('p5_3_Mean Accuracies for Different Threshold Values.png')