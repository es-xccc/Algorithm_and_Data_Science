...
plt.savefig('p5_4_Threshold values k for Maximum Accuracies.png')
...
plt.savefig('p5_4_Maximum Accuracies.png')
...
plt.legend()
plt.savefig('p5_4_Mean Accuracies for Different Threshold Values.png')