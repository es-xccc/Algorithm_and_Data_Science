...
plt.savefig('p5_2_Threshold values k for Maximum Accuracies.png')
...
plt.savefig('p5_2_Maximum Accuracies.png')
...
plt.legend()
plt.savefig('p5_2_Mean Accuracies for Different Threshold Values.png')