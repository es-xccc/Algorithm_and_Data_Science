...
plt.savefig('p3_Threshold values k for Maximum Accuracies.png')
...
plt.savefig('p3_Maximum Accuracies.png')
...
plt.legend()
plt.savefig('p3_Mean Accuracies for Different Threshold Values.png')